...
namespace Wineventory.Web.Utils
{
    public static class HandlerRegistration
    {
        ...
        {
            //Get possible attributes on the handler
        ...
        private static Type ToDecorator(object attribute)
        {
            ...
            //TODO: Refactor this logic should be in a base attribute class, and loop trough ,
            //attributes calling the register method
            if (type == typeof(LoggingAttribute))
